...
public class Grid2DListTest {
	...
	public void testCreate1by1Grid() {
		this.grid = new Grid2DList(1, 1, neighborhoodMock, startingPatternMock);

		assertThat(grid.getGrid().size(), is(1));
		assertThat(grid.getGrid().get(0).size(), is(1));
	}

	@Test
	public void testCreate10by100Grid() {
		grid = new Grid2DList(10, 100, neighborhoodMock, startingPatternMock);

		assertThat(grid.getGrid().size(), is(10));
		assertThat(grid.getGrid().get(0).size(), is(100));
	}

	@Test
	public void testCreate9999by9999Grid() {
		grid = new Grid2DList(9999, 9999, neighborhoodMock, startingPatternMock);

		assertThat(grid.getGrid().size(), is(9999));
		assertThat(grid.getGrid().get(0).size(), is(9999));
	}
	// endregion
	...
	public void testSetState() {
		grid = new Grid2DList(10, 10, neighborhoodMock, startingPatternMock);
	...
	public void testSetStateAtNegativeCol() {
		Grid2DList grid = new Grid2DList(10, 10, neighborhoodMock, startingPatternMock);
	...
	public void testEqualsForEqualGrids() {
		grid = new Grid2DList(1, 1, neighborhoodMock, startingPatternMock);
		IGrid other = new Grid2DList(1, 1, neighborhoodMock, startingPatternMock);
	...
	public void testEqualsForUnequalGridCols() {
		grid = new Grid2DList(1, 1, neighborhoodMock, startingPatternMock);
		IGrid other = new Grid2DList(2, 1, neighborhoodMock, startingPatternMock);
	...
	public void testEqualsForUnequalGridRows() {
		grid = new Grid2DList(1, 1, neighborhoodMock, startingPatternMock);
		IGrid other = new Grid2DList(1, 2, neighborhoodMock, startingPatternMock);
	...
	public void testEvolveNextGenerationForPatternChessFieldRulesetGameOfLife() {
		grid = new Grid2DList(2, 2, neighborhoodMock, startingPatternMock);
		...
		IGrid other = new Grid2DList(2, 2, neighborhoodMock, startingPatternMock);
	...
	public void testGetGridConfiguration() {
		grid = new Grid2DList(3,3, neighborhoodMock, startingPatternMock);
	...
	public void testGridConfigurationIndexOutOfBoundsExceptionCols() {
		grid = new Grid2DList(0,3, neighborhoodMock, startingPatternMock);
	}

	@Test(expected = IndexOutOfBoundsException.class)
	public void testGridConfigurationIndexOutOfBoundsExceptionRows() {
		grid = new Grid2DList(3,0, neighborhoodMock, startingPatternMock);
	}

	@Test(expected = IndexOutOfBoundsException.class)
	public void testGridConfigurationIndexOutOfBoundsExceptionRowsAndCols() {
		grid = new Grid2DList(0,0, neighborhoodMock, startingPatternMock);
	}
